...
class NameAnalyzer {
    constructor() {
        // No need to assign phonetic algorithms to 'this'.
    }
    ...
    analyzePhoneticTexture(name) {
       ...
       // Get phonetic codes
        ...
        const soundexCode = soundex.process(name);
        const metaphoneCode = metaphone.process(name);
        const dmCodes = doubleMetaphone.process(name);
